...
SECRET_KEY = 'django-insecure-+9(asynj$(lsfh9+n$369#mp&&_xi(tl$ws^i5og5npsryv57q'
...
#
LOGIN_REDIRECT_URL = '/<str:username>_profile'
LOGIN_URL = '/login'

EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
DEFAULT_FROM_EMAIL = 'chachukhay@gmail.com'
EMAIL_USE_TLS = True
EMAIL_USE_SSL = False
